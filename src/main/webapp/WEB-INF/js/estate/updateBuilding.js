$(function(){
    ...
    querySelectDict("lygn", "楼宇功能",'l');
    querySelectDict("jglb", "结构类别",'j');
    querySelectDict("zxbz", "装修标准",'z');
    querySelectDict("wsdj", "完损等级",'w');
...
function addHomeSubmit() {
    ...
    if (bootstrapValidator.isValid()) {
        ...
        console.log(option);
        $.ajax({
            url: rootPath+'building/updateBuilding?' + option,
            data: '',
            dataType: 'json',
            type: 'post',
            async: false,
