...
$(function(){
    ...
    querySelectDict("hx", "房间户型",'');
    querySelectDict("cx", "朝向",'');
    querySelectDict("zx", "装修标准",'');
    querySelectDict("wylx", "房间物业类型",'');
    querySelectDict("fjxz", "房间性质",'');
    querySelectDict("fjzt", "车位状态",'');
...
function addHomeSubmit() {
    ...
    if (bootstrapValidator.isValid()) {
        ...
        console.log(option);
        $.ajax({
            url: rootPath+'room/addRoom?' + option,
            data: '',
            dataType: 'json',
            type: 'post',
            async: false,
