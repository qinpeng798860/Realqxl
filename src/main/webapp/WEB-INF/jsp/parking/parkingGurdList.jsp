...
<head>
    ...
    <%--选项卡js--%>
    <script src="js/parking/GuardList.js"></script>
    <title>车位维护</title>
</head>
<body>
...
<div>
    <ul class="nav nav-tabs" id="zzxx">
        <li style="padding-left: 650px;" class="active">快速检索：</li>
        <li class="active"><select class="form-control" id="ksjs">
        </select></li>
        <li class="active"><input type="text" class="form-control" id="zzbh "></li>
        <li class="active" >
            <div >
                <button type="button" class="btn btn-primary" onclick="queryGuard()">查询</button>
