...
<head>
    ...
    <%--选项卡js--%>
    <script src="js/estate/HomesMaintenance.js"></script>
    <title>住宅维护</title>
</head>
...
<table id="typeServerTable">
    ...
    <div>
        <ul class="nav nav-tabs" id="zzxx">
            ...
            <li style="padding-left: 650px;" class="active">房间信息授权楼盘数量：</li>
            <li class="active"><select class="form-control" id="ssgs">
                <option>请选择</option>
            </select></li>
            <li class="active"><input type="text" class="form-control" id="zzbh "></li>
            <li class="active" >
                <div >
                        <button type="button" class="btn btn-primary " onclick="addTypeServer();">新增住宅</button>
