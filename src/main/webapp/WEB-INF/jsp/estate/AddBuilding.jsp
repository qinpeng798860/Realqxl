...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <script src="js/estate/addBuilding.js"></script>
...
<form  id="addBuildingFrom" method="post">
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-5">
            ...
            <input type="text" class="form-control" id="lymc" name="lymc">
        </div>
        <div class="form-group col-lg-5">
            <label for="dysl">单元数量</label>
            <input type="text" class="form-control" id="dysl" name="dysl">
        </div>
    </div>
    <div class="row">
        <div class="form-group col-lg-1">
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-5">
            ...
            <input type="text" class="form-control" id="jzxkz" name="jzxkz">
        </div>
        <div class="form-group col-lg-5">
            <label for="ysxkz">预售许可证</label>
            <input type="text" class="form-control" id="ysxkz" name="ysxkz">
        </div>
    </div>
